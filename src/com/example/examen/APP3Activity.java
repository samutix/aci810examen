...
public class APP3Activity extends Activity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            if(i.hasExtra(APP2Activity.EXTRA_LIBRO))
            {
                    Libro l = (Libro) i.getSerializableExtra(APP2Activity.EXTRA_LIBRO);
        ...
        public void savelibro(View view) {
                EditText tituloField = (EditText) this.findViewById(R.id.tituloField);
                ...
                {
                        l = ds.createLibro(tituloName, authorName, isbnName);
                }
                
                Intent i = new Intent();
                i.putExtra(APP2Activity.EXTRA_LIBRO, l);
                i.putExtra(APP2Activity.EXTRA_REMOVE, false);
        ...
        public void onDeleteButtonClicked(View view) {
                ...
                Intent i = new Intent();
                i.putExtra(APP2Activity.EXTRA_LIBRO, l);
                i.putExtra(APP2Activity.EXTRA_REMOVE, true);
                this.setResult(RESULT_OK, i);
